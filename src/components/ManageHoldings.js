...
import { addHolding, removeHolding } from "../store/holding-slice";
...
const columns = [
  ...
  { id: "targetPrice", label: "Target Price", minWidth: 10 },
...
const ManageHoldings = () => {
  const rows = useSelector((state) => state.holding.holdings);
  ...
  const formHandler = (event) => {
    ...
    const obj = {
      ...
      targetPrice: enteredTargetPrice,
      ...
      <Grid container>
        <Grid item md={12} xs={12} sm={12}>
          <div>
            ...
            >
              <span className="material-icons">add</span> Add Holdings
            </Button>
          </div>
        </Grid>
        <Grid item md={12} xs={12} sm={12}>
          ...
          >
            <Fade in={open}>
              <div className={classes.paper}>
                ...
                >
                  <h2 id="transition-modal-title">Add Holdings</h2>
                </div>
                <Divider />
                <div>
                  <form
                    ...
                    <Grid container>
                      ...
                      <Grid item md={6} lg={6} xs={12} sm={12}>
                        <TextField
                          ...
                          size="small"
                          style={{ width: "100%" }}
                          onChange={(e) => changeHandler(e, "targetPrice")}
